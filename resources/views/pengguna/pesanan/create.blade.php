...
@section('content')
<form action="{{ route('pengguna.pesanan.store') }}" method="POST">
    @csrf
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Informasi Pesanan Anda</h3>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card card-secondary">
                ...
                <div class="card-body">
                    ...
                    <button type="button" id="btn-tambah-layanan" class="btn btn-success float-right">Tambah Layanan</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Rincian Pesanan Anda</h3>
        </div>
        <div class="card-body table-responsive">
            ...
            <table class="table">
                ...
                <tfoot>
                    <tr>
                        <th colspan="3" class="text-right">Estimasi Total Harga:</th>
